...
if not is_valid:
    ...
    tabs_list = ["Вкладка 1", "Вкладка 2", "Вкладка 3", "Вкладка 4", "Вкладка 5", "Вкладка 6"]
    chosen = st.radio(
        "Вкладки:",
        tabs_list,
    ...
    if chosen == "Вкладка 1":
        ...
        fin_opt = calculate_financials(opt_params, disable_extended=False)
        fin_pes = calculate_financials(pes_params, disable_extended=False)
        fin_real = calculate_financials(real_params, disable_extended=False)
        ...
        chart_scen = ChartDisplay("Сравнение: Доход, Расход, Прибыль")
