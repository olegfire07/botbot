...
def display_tab3_header(tab):
    with tab:
        ...
        st.info(
            "Здесь рассчитывается уровень дохода, при котором склад выходит на ноль по прибыли."
        )
...
def display_tab3_sensitivity(tab, params, disable_extended=False):
    with tab:
        ...
        reverse_map = dict(param_display_map)
        ...
        for key in selected_keys:
            ...
            chart = ChartDisplay(f"Чувствительность: {ru_label}", x_title=ru_label)
