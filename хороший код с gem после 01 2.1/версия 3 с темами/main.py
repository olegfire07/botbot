...
with st.sidebar:
    ...
    with st.sidebar.expander("### Распределение площади"):
        mode = st.radio(
    ...
    with st.sidebar.expander("### Процент заполняемости"):
    ...
    with st.sidebar.expander("### Отток клиентов/вещей (%)"):
    ...
    with st.sidebar.expander("### Переменные расходы"):
    ...
    # --- Инфляция и рост ---
    with st.sidebar.expander("### Инфляция и рост"):
