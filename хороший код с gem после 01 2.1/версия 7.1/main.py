...
with st.sidebar:
  ...
  # --- Расширенные параметры ---
    ...
    if enable_ml_settings_val and forecast_method.startswith("ML"):
        ...
        app_state.set("uploaded_model", uploaded_model) # Сохраним в сессию
    else:
        app_state.set("df_for_ml", None)
...
params = WarehouseParams(
    ...
    param_search_method=app_state.get("param_search_method") # Получаем из состояния
)
...
if not is_valid:
    ...
    display_tab1(tab1, base_financials, pm, pr, roi_val, irr_val, params, selected_param, main_color, npv_val)
        ...
        if df_for_ml is not None:
            ...
            ml_model = load_ml_model(
                ...
                auto_feature_selection=params.auto_feature_selection,
                 uploaded_model_file=app_state.get("uploaded_model")
            )
